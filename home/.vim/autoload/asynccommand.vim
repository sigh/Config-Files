...
function! asynccommand#done(temp_file_name)
  ...
  " Return the current character so that the the display doesn't get screwed up.
  " (This will get printed out to the current cursor position). Returning the
  " empty string will make the cursor disappear.
